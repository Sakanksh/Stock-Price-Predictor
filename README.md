...
6.  **Model Training**: Compiles and trains the LSTM model.
7.  **Prediction and Evaluation**: Generates predictions on the test set, inverse-transforms the predictions, and compares them with real stock prices.
8.  **Visualization of Predictions**: Plots the real vs. predicted stock prices for a clear comparison.

## How to Run
1.  **Upload Data**: Ensure you have the `TSLA.csv` file in your Colab environment or update the path in the data loading cell.
2.  **Run All Cells**: Execute all cells in the notebook sequentially. The model will be trained, and predictions will be generated and visualized.
